...
def m_projection(fov, aspect_ratio, near, far):
...
def t_clip_against_plane(plane_p, plane_n, in_tri, out_tri1, out_tri2):
    ...
    d0 = dist(in_tri[0], plane_n, plane_p)
    d1 = dist(in_tri[1], plane_n, plane_p)
    d2 = dist(in_tri[2], plane_n, plane_p)
